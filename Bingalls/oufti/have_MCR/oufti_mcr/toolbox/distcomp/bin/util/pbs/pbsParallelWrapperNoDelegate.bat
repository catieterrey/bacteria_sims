...
echo !MPIEXEC! -noprompt -l -exitcodes -genvlist %GENVLIST% -machinefile %PBS_NODEFILE% -n %MDCE_TOTAL_TASKS% !MDCE_MATLAB_EXE! %MDCE_MATLAB_ARGS%
call !MPIEXEC! -noprompt -l -exitcodes -genvlist %GENVLIST% -machinefile %PBS_NODEFILE% -n %MDCE_TOTAL_TASKS% !MDCE_MATLAB_EXE! %MDCE_MATLAB_ARGS%
