...
public class BSimChenOscillatorExample {
    ...
    public List<Double> qsPars = new ArrayList<>(Arrays.asList(new Double[] {0., 2.1, 0., 2.}));
    ...
    public void run() {
        ...
        sim.setSimulationTime(100);       // 36000 = 10 hours; 600 minutes.
...
//        popGen.mixedAsBlock(nActivatorStart, nRepressorStart);
        ...
        final ArrayList<ActivatorBacterium> act_switch = new ArrayList();
        final ArrayList<RepressorBacterium> rep_switch =new ArrayList();
...
//                        }
                ...
                for (ActivatorBacterium b : bacteriaActivators) {
                    ...
                    if(n<=i_e_field.getConc(b.position)){
                        ...
                        if(b.get_count()>50){
                            act_switch.add(b);
                            RepressorBacterium newbac = new RepressorBacterium (sim, b.x1, b.x2,
                                    b.H_e_field, b.I_e_field, b.grn_state);
                            rep_switch.add(newbac);}
                    }
                }
                bacteriaActivators.removeAll(act_switch);
                bacteriaAll.removeAll(act_switch);
                bacteriaRepressors.addAll(rep_switch);
                bacteriaAll.addAll(rep_switch);
                act_switch.clear();
                rep_switch.clear();
...
//        BSimDrawer drawer1 = new BSimDrawer(sim,800,600) {
//            @Override
//            public void draw(Graphics2D g) {
...
//        }
        ...
        if(export) {
            ...
            String filePath = BSimUtils.generateDirectoryPath("/Users/Francesca/Desktop/IngallsLab/" + simParameters + "/");
...
//            sim.addExporter(posLogger);
            ...
            BSimLogger posLogger = new BSimLogger(sim, filePath + "position.csv") {
                ...
                public void before() {
                    super.before();
                    write("per Act; per Rep; id, p1x, p1y, p1z, p2x, p2y, p2z, growth_rate");
                }
